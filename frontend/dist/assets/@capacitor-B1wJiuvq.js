...
const Filesystem = registerPlugin("Filesystem", {
  web: () => __vitePreload(() => Promise.resolve().then(() => web$1), true ? void 0 : void 0).then((m) => new m.FilesystemWeb())
});
f();
const Share = registerPlugin("Share", {
  web: () => __vitePreload(() => Promise.resolve().then(() => web), true ? void 0 : void 0).then((m) => new m.ShareWeb())
});
